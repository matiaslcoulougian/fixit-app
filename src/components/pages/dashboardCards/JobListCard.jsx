...
const JobListCard = () => {
    ...
    return (
        <div>
            <div className="card">
                <h3 className="card-header d-flex justify-content-between align-items-start">Active Jobs</h3>
                {/*<span className={"btn"}><i*/}
                {/*    className="bi bi-plus-square"></i></span>*/}
                <div className="card-body">
                    ...
                    <div className={"list-group mb-2"}>
                        {postsLoading ?
                            ...
                            :
                            selectedJobs.map((job) => <div className={"list-group-item d-flex justify-content-between align-items-start"}>{`${job.title}`}<span class="badge rounded-pill bg-primary">{capitalize(job.type.replace("_", " "))}</span></div>)
                        }
                    </div>
